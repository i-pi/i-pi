    ...
    for l in range(N - k, N):
        for j in range(P):
            ...
            if j == P - 1:
                ...
                if l == N - 1:      # KAREN: flake8 complains about 'l' as a name of a variable. But I would keep it as in the paper.
...
def Evaluate_dEkn_on_atom(self, l, j, N, k):
    ...
    if j == 0:
        ...
        if l == N - k:      # KAREN: flake8 complains about 'l' as a name of a variable. But I would keep it as in the paper.
