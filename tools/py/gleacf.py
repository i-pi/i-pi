...
if __name__ == '__main__':
    ...
    parser.add_argument("-DP", "--deconv_param", nargs=2, type=int, default=[500, 10], help="The parameters associated with the deconvolution. Since the operation is based on an iterative algorithm, it requires the total number of epochs NEPOCHS and the stride PSTRIDE at which the output spectrum is returned. Usage: -DP NEPOCHS PSTRIDE")
