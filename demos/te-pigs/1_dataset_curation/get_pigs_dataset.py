...
physical_force_filename='../0_reference_pimd/simulation.physical_force_on_centroid.extxyz'

atoms_list = []
for a_pos, a_cforce, a_pforce in zip(iread(position_filename), iread(centroid_force_filename), iread(physical_force_filename)):
        ...
        atoms.arrays['delta_force'] =  a_cforce.arrays['forces_component_raw'] - a_pforce.arrays['forces_component_raw']
