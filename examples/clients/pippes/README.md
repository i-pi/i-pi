...
(2) Download the CH5<sup>+</sup> potential and the associated interface from the repository pippes at https://github.com/szquchen/pippes. These are located in the folder `03_ch5p`.
